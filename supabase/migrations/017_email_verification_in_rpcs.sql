-- Migration: 017_email_verification_in_rpcs
-- Date: 2026-02-16
-- Description: Add is_email_verified() check to save_minutes_atomic() and
--   save_agenda_atomic() RPCs that bypass RLS (CR-001 from security review)
-- Depends on: 016_distribution_contacts_with_check

-- Add email verification check to save_minutes_atomic
...
-- Add email verification check to save_agenda_atomic
